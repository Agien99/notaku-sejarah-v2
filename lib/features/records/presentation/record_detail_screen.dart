      ...
      child: Center(
        child: ConstrainedBox(
          ...
          child: ListView(
            ...
            children: [
              Text(
                'Tingkatan ${record.form} • Bab ${record.chapter}',
              ...
              Text(
                'Tempoh: ${record.duration.inMinutes} min '
                ...
                Card(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${index + 1}. ${record.answers[index].prompt}',
                          style: Theme.of(context).textTheme.titleMedium,
                        ),
                        const SizedBox(height: 12),
                        Text(
                          record.answers[index].isCorrect
                              ? '✓ Betul'
                              : '✗ Salah',
                        ),
                        Text(
                          'Jawapan anda: ${record.answers[index].selectedAnswer}',
                        ),
                        Text(
                          'Jawapan betul: ${record.answers[index].correctAnswer}',
                        ),
